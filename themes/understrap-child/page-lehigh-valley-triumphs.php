<?php
/**
 * The template for displaying Lehigh valley triumphs.
 *
 *
 * @package understrap
 */
...
<div class="wrapper" id="main_content" role="main">
	...
	<div class="<?php echo esc_attr( $container ); ?>" id="content" tabindex="-1">
			...
			<main class="site-main">
				...
				<div class="row mt-4">
					<div class="col-sm-12">		
						<h1 class="subscribe-box-title">Lehigh Valley Triumphs</h1>
					</div>
				</div>	
					...
					<div class="col-sm-6 text-right">
						...
						<form class="form-inline pull-right ml-1" action="<?php echo home_url( '/' ); ?>" role="search" method="get">
					      <div class="input-group">
		                      ...
		                      <input type="text" class="form-control search-text" name="s" placeholder="Search Triumphs" id="s">
		                      <i class="fa fa-search search-icn"></i>
		                      <input type="hidden" value="triumph" name="post_type" />
