...
if ( ! function_exists( 'understrap_post_nav_custom' ) ) {
	function understrap_post_nav_custom() {
		...
		<nav class="container navigation post-navigation mt-4">
			...
			<div class="row nav-links justify-content-between">
				...
				if ( get_previous_post_link() ) {
					previous_post_link( '<span class="nav-previous">%link</span>', _x( '<i class="fa fa-angle-left"></i>&nbsp; Previous Story', 'Previous post link', 'understrap' ) );
				}
				if ( get_next_post_link() ) {
					next_post_link( '<span class="nav-next">%link</span>', _x( 'Next Story &nbsp;<i class="fa fa-angle-right"></i>', 'Next post link', 'understrap' ) );
				}
				?>
			</div><!-- .nav-links -->
		</nav><!-- .navigation -->
